...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-5.11-kirby-problem-5.11-fccec64b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-5.11"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-5.11-kirby-problem-5.11-fccec64b-v1",
      "problem_contract_sha256": "4f423de2e12afb3367db3db38fb145d3d3fd0a7cef8c2fa828bd2f344f4506dc",
      "problem_id": "problem:um-kp-5.11-kirby-problem-5.11-fccec64b",
      "route_id": "route:um-kp-5.11-kirby-problem-5.11-fccec64b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-5.11-kirby-problem-5.11-fccec64b-source-fidelity-01",
      "graph_id": "graph:um-kp-5.11-kirby-problem-5.11-fccec64b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-5.11-kirby-problem-5.11-fccec64b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-5.11-kirby-problem-5.11-fccec64b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(Whitehead's Asphericity Question). Is every subcomplex of an aspherical 2-complex aspherical?"
          },
          "statement_sha256": "19687cd5c1dc213f9edf8057d7d04d4583535b52ea1702f944c6fe0ad3fc98a3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-5.11-kirby-problem-5.11-fccec64b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-5.11-kirby-problem-5.11-fccec64b-root",
      "route_id": "route:um-kp-5.11-kirby-problem-5.11-fccec64b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-5.11-2e01e3ebea0e",
        "url": "https://www.unsolvedmath.com/problems/KP-5.11"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
